    ...
    const pad4 = (v?: string) => (v ? String(parseInt(v as any, 10) || 0).padStart(4, '0') : '');
      ...
      if (cameraConfiguration === 1) {
        ...
        for (let i = 1; i <= cameraConfiguration; i++) {
          ...
          console.log(`[handleSaveWithInsertBefore] tempCamera[${i}]: ${tempCamera[i]}`);
        }
      }
      ...
      if (!disabledFields.has('soundFile') && tempSound !== null) {
        ...
        if (soundIncrement > 0) {
          ...
          console.log(`✅ [handleSaveWithInsertBefore] Shifted sound files: start=${soundStart} (inserted log lower bound), increment=${soundIncrement}, tempSound=${tempSound} (upper bound)`);
        }
      }
      ...
      if (cameraConfiguration === 1) {
        if (!disabledFields.has('cameraFile') && tempCamera[1] !== null) {
          ...
          if (camIncrement > 0) {
            ...
            console.log(`✅ [handleSaveWithInsertBefore] Shifted camera files: start=${camStart} (inserted log lower bound), increment=${camIncrement}, tempCamera[1]=${tempCamera[1]} (upper bound)`);
          }
        }
      } else {
        for (let i = 1; i <= cameraConfiguration; i++) {
          ...
          if (!disabledFields.has(fieldId) && tempCamera[i] !== null) {
            ...
            if (camIncrement > 0) {
              ...
              console.log(`✅ [handleSaveWithInsertBefore] Shifted ${fieldId}: start=${camStart} (inserted log lower bound), increment=${camIncrement}, tempCamera[${i}]=${tempCamera[i]} (upper bound)`);
            }
          }
        }
      }
